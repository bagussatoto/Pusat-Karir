...
<body class="hold-transition skin-blue sidebar-mini wysihtml5-supported fixed animated ">
		...
		<aside class="main-sidebar">
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu">
					...
					<?php  
					if (isset($perusahaan)) {					?>
					<li class="active treeview animated fadeInDown">
						<a href="#">
				...
				if (isset($admin_a)) {
					...
					<li class="active treeview animated fadeInDown">
						...
						<ul class="treeview-menu">
							<li class="animated fadeInDown"><a href="<?php echo site_url('admin/verifikasi_p/'); ?>"><i class="fa fa-circle-o"></i> Verifikasi Perusahaan </a></li>
							<li class="animated fadeInDown"><a href="<?php echo site_url('admin/perusahaan/'); ?>"><i class="fa fa-circle-o"></i> Daftar Perusahaan </a></li>
						</ul>
					</li>
					<li class="treeview animated fadeInDown">
						<a href="#">
						...
						<ul class="treeview-menu">
							<li class="animated fadeInDown"><a href="<?php echo site_url('admin/alumni/'); ?>"><i class="fa fa-circle-o"></i> Daftar Alumni</a></li>
						</ul>
					</li>
					<li class="treeview animated fadeInDown">
						<a href="#">
				...
				if (isset($alumni)) {
					...
					<li class="treeview animated fadeInDown">
						...
						<ul class="treeview-menu">
							<li class="animated fadeInDown"><a href="<?php echo site_url('alumni/berkas/'); ?>"><i class="fa fa-circle-o"></i> Daftar Berkas </a></li>
						</ul>
					</li>
					<li class="treeview animated fadeInDown">
						<a href="#">
							<i class="fa fa-file-alt"></i>
							<span>Pengumuman Test & Hasil</span>
							<span class="float-right fa fa-angle-down"></span>
						</a>
						<ul class="treeview-menu">
							<li class="animated fadeInDown"><a href="<?php echo site_url('alumni/pengumuman/'); ?>"><i class="fa fa-circle-o"></i> Daftar Pengumuman </a></li>
						</ul>
					</li>
					<li class="treeview animated fadeInDown">
						<a href="#">
						...
						<ul class="treeview-menu">
							<li class="animated fadeInDown"><a href="<?php echo site_url('alumni/rekomendasi/'); ?>"><i class="fa fa-circle-o"></i> Daftar Rekomendasi </a></li>
						</ul>
					</li>
					<?php } ?>
				</ul>
	...
	<script type="text/javascript">
		...
		$('.select2').select2();
		<?php  
		if ($this->uri->segment(1)=='admin' && $this->uri->segment(2)=='perusahaan') {
			?>
			...
			function createModal(data){
				...
				if (logo==null) {
					...
					logo = '<?= base_url('assets/dist/img/prusahaan/')?>'+logo;
				}
		...
		if ($this->uri->segment(1)=='admin' && $this->uri->segment(2)=='verifikasi_p') {
			?>
			function show_detail_p(idp) {
				$.ajax({
			...
			function createModal(data){
				...
				var link = '<?= base_url('assets/dist/file/perusahaan/');?>'+surat;
				...
				baris += '<tr><td>Email</td><td>:</td><td>'+mail+'</td></tr>';
				baris += '<tr><td>Jenis Perusahaan</td><td>:</td><td>'+jenis+'</td></tr>';
				baris += '<tr><td>Surat Ijin</td><td>:</td><td><a title="periksa Surat" href="'+link+'" target="_blank">'+surat+'</a></td></tr>';
