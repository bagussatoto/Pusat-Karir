...
<a href="<?= site_url('admin/pelamar/status_pelamar/ditolak/'.$data->id_pelamar);?>" class="btn btn-danger btn-sm">Tolak Sebagai Pelamar</a> &nbsp;
<a href="<?= site_url('admin/pelamar/status_pelamar/diterima/'.$data->id_pelamar);?>" class="btn btn-success btn-sm">Terima Sebagai Pelamar</a>
